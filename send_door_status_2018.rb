...
loop do
	...
	uri = URI.parse("https://o9q636x114.execute-api.ap-northeast-2.amazonaws.com/toilet")
        response = nil

        request = Net::HTTPS::Post.new(uri.request_uri, initheader = {'Content-Type' =>'application/json'})
